...
public class BucketInventorySample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            client.setBucketInventoryConfiguration(bucketName, inventoryConfiguration);

            // get bucket inventory configuration.
            GetBucketInventoryConfigurationResult getResult = client.getBucketInventoryConfiguration(
            ...
            while (true) {
                ListBucketInventoryConfigurationsRequest listRequest = new ListBucketInventoryConfigurationsRequest()
                        .withBucketName(bucketName).withContinuationToken(continuationToken);
                // at most 100 results can be returned every list request.
                ListBucketInventoryConfigurationsResult result = client.listBucketInventoryConfigurations(listRequest);
            ...
            DeleteBucketInventoryConfigurationRequest delRequest = new DeleteBucketInventoryConfigurationRequest()
                    .withBucketName(bucketName).withInventoryId(id);
            client.deleteBucketInventoryConfiguration(delRequest);
    ...
    private static void printInventoryConfig(InventoryConfiguration config) {
        ...
        System.out.println("isenabled:" + config.getIncludedObjectVersions());
