...
public class DeleteBucketInventoryConfigurationRequest extends GenericRequest {
    ...
    public DeleteBucketInventoryConfigurationRequest(String bucketName, String inventoryId) {
    ...
    /**
     * Sets the name of the bucket containing the inventory configuration to delete.
     * And returns the {@link DeleteBucketInventoryConfigurationRequest} object itself.
     */
    ...
    /**
     * Sets the inventory id used to identify the inventory configuration and
     * returns the {@link DeleteBucketInventoryConfigurationRequest} object itself.
     */
    public DeleteBucketInventoryConfigurationRequest withInventoryId(String inventoryId) {
