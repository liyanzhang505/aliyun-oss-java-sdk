...
public class GetBucketInventoryConfigurationRequest extends GenericRequest {
    ...
    /**
     * Sets the name of the bucket containing the inventory configuration to retrieve.
     * And returns the {@link GetBucketInventoryConfigurationRequest} object itself.
     */
     ...
     * And returns the {@link GetBucketInventoryConfigurationRequest} object itself.
     */
    public GetBucketInventoryConfigurationRequest withInventoryId(String inventoryId) {
