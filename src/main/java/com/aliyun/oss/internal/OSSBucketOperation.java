...
public class OSSBucketOperation extends OSSOperation {
    ...
    public ObjectListing listObjects(ListObjectsRequest listObjectsRequest) throws OSSException, ClientException {
        ...
        Payer payer = listObjectsRequest.getRequestPayer();
        if (payer != null) {
        	listObjectsRequest.addHeader(OSSHeaders.OSS_REQUEST_PAYER, payer.toString().toLowerCase());
        }
    ...
    public VersionListing listVersions(ListVersionsRequest listVersionsRequest) throws OSSException, ClientException {
        ...
        Payer payer = listVersionsRequest.getRequestPayer();
        if (payer != null) {
        	listVersionsRequest.addHeader(OSSHeaders.OSS_REQUEST_PAYER, payer.toString().toLowerCase());
        }
